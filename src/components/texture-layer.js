...
export class TextureLayer extends Component {
    ...
    constructor(props) { //material, path filenames
        super(props);
        ...
        if (this.props.path && this.props.filenames) {
            this.props.filenames.forEach(fname => {
                ...
                let fullpath = this.props.path + fname + '.png';
    ...
    getDownloadTexture() {
        ...
        console.log(this.props.material.color.getHexString());
    ...
    render() {
        return(
            <ColorPicker label={this.props.label} material={this.props.material} defaultColor={this.defaultColor} ref={this.colorPicker}/>
        );
    }
